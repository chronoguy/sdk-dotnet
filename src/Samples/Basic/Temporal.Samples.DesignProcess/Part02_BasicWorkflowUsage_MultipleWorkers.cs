...
{
    /// <summary>
    /// Some very simple workflows. The level of abstraction is the same as in <see cref="Part01_BasicWorkflowUsage" />.
    /// Here, we focus on multiple workers per process.    
    /// </summary>
    public class Part02_BasicWorkflowUsage_MultipleWorkers
    {
